...
`:`<br>
`:`
`};Ee.text=function(e,u){return Oe(e[u].content)};Ee.html_block=function(e,u){return e[u].content};Ee.html_inline=function(e,u){return e[u].content};function Ge(){this.rules=_u({},Ee)}Ge.prototype.renderAttrs=function(u){let t,n,r;if(!u.attrs)return"";for(r="",t=0,n=u.attrs.length;t<n;t++)r+=" "+Oe(u.attrs[t][0])+'="'+Oe(u.attrs[t][1])+'"';return r};Ge.prototype.renderToken=function(u,t,n){const r=u[t];let i="";if(r.hidden)return"";r.block&&r.nesting!==-1&&t&&u[t-1].hidden&&(i+=`
